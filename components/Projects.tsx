...
const projects: Project[] = [
  { title: "Code Migration Agent + MCP Server", description: "Autonomous AI agent + MCP server that migrates codebases to the latest framework versions using AST parsing and Anthropic Claude API. Exposes migration tools consumable by any MCP-compatible client.", image: "🤖", tags: ["Claude API", "MCP", "Python", "Agentic AI"], live: null, featured: true, color: "#7C3AED", bg: "#F3E8FF", client: "Personal / Open Source", type: "ai", highlight: true },
  ...
  { title: "LEARNET-RIL", description: "Video and text-based interactive learning platform for Reliance employees to share knowledge, success stories, and connect with subject-matter experts. Published on the Play Store.", image: "🎓", tags: ["Android", "Kotlin", "SQLite", "ExoPlayer", "Firebase"], live: "https://play.google.com/store/apps/details?id=com.ril.learnet", featured: true, color: "#1b63e8", bg: "#eef3ff", client: "Reliance Industries", type: "mobile" },
  ...
  { title: "Share-A-Ride", description: "Carpooling app for Reliance employees using intelligent route-matching and real-time GPS tracking with colleague verification. Available on the Play Store.", image: "🚗", tags: ["Android", "Kotlin", "Firebase", "Google Maps", "FCM"], live: "https://play.google.com/store/apps/details?id=com.ril.shareAride", featured: true, color: "#ef4444", bg: "#fef2f2", client: "Reliance Industries", type: "mobile" },
  { title: "JIO-HRU", description: "Jio HR companion app — employees view payslips, tax projections, HR details, and manage the entire candidate onboarding workflow digitally.", image: "👥", tags: ["Android", "SAP Android SDK", "SOAP", "Kotlin"], live: null, featured: true, color: "#8b5cf6", bg: "#f5f3ff", client: "Reliance Jio", type: "mobile" },
